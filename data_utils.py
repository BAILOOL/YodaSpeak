...
"""Utilities for data tokenizing vocabularies creation"""
...
def prepare_wmt_data(data_dir, en_vocabulary_size, yoda_vocabulary_size, tokenizer=None):
  """Get Yoda data into data_dir, create vocabularies and tokenize data.

  Args:
    data_dir: directory in which the data sets will be stored.
    en_vocabulary_size: size of the English vocabulary to create and use.
    yoda_vocabulary_size: size of the Yoda vocabulary to create and use.
    tokenizer: a function to use to tokenize each data sentence;
      if None, basic_tokenizer will be used.
  ...
  Returns:
    A tuple of 6 elements:
      ...
      (2) path to the token-ids for Yoda training data-set,
      (3) path to the token-ids for English development data-set,
      (4) path to the token-ids for Yoda development data-set,
      (5) path to the English vocabulary file,
      (6) path to the Yoda vocabulary file.
  """
  # Get yoda data to the specified directory
  from_train_path = data_dir + "/Training_from_clean.en"
  to_train_path = data_dir + "/Training_to_clean.yoda"
  from_dev_path = data_dir + "/Training_from_clean.en"
  to_dev_path = data_dir + "/Training_to_clean.yoda"
  return prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, en_vocabulary_size,
                      yoda_vocabulary_size, tokenizer)
